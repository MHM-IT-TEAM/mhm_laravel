...
Route::get('/free_bed/{service_id}',[\App\Http\Controllers\medical\beds\BedController::class,'free_in_service']);
...
Route::group(['prefix'=>'generalist'],function(){
    route::resource('/consultation',\App\Http\Controllers\V1\medical\out_patient\GeneralistController::class);
});
