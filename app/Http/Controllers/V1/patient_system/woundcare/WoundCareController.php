...
namespace App\Http\Controllers\V1\patient_system\woundcare;

use App\Http\Controllers\Controller;
use App\Models\StorkWoundCare;
use App\Models\Woundcare;
use App\Service\V1\patient_system\WoundCareService;
...
class WoundCareController extends Controller
{
    ...
    {
        $wc = new WoundCareService();
        return $wc->store($request);
    }
