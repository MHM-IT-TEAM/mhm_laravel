            ...
            ->map(function($birth){
                return [
                    ...
                    "mom"=>[
                        ...
                        'G'=>(isset($birth->cpnAdmission))?$birth->cpnAdmission['gravida']:'','P'=>(isset($birth->cpnAdmission))?$birth->cpnAdmission['parity']:'','A'=>(isset($birth->cpnAdmission))?$birth->cpnAdmission['abortion']:'','EV'=>(isset($birth->cpnAdmission))?$birth->cpnAdmission['ev']:'','M'=>(isset($birth->cpnAdmission))?$birth->cpnAdmission['miscarriage']:'',
                        'lpd'=>(isset($birth->cpnAdmission))?$birth->cpnAdmission['dda']:'',
