            ...
            <div class="table-responsive">
                ...
                <table class="table table-sm">
                    ...
                    <tr v-if="formData.admission_priority_id===3">
                        <td colspan="3">Provisional Diagnosis<span class="text-danger">*</span></td>
                    </tr>
                    <tr v-if="formData.admission_priority_id===3">
                        <td colspan="5">
                            <textarea class="form-control form-control-sm required" v-model="formData.provisional_diagnosis" ></textarea>
                            <span v-if="$v.formData.provisional_diagnosis.$error" class="text-white bg-danger">Please provide a provisional diagnosis</span>
                        </td>
                    </tr>
                    <tr>
                        <td>Temp</td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="number" class="required" style="width:40px" v-model="formData.taDia" :disabled="formData.patient.id===''"/>
                        </td>
                        <td>
...
<!--                        </tr>-->
                ...
                <v-dialog
                    v-model="accessory.height_modal"
                    max-width="290"
                >
                    <v-card>
                        ...
                        <v-card-text>
                            <input type="number" class="form-control form-control-sm" @keydown.enter.prevent="update_patient_height" v-model="formData.patient.height"/>
                        </v-card-text>
                    </v-card>
                </v-dialog>
            </div>
    ...
    export default {
        ...
        validations:{
            formData:{
                ...
                provisional_diagnosis: {required:requiredIf(formData=>formData.admission_priority_id===3)}
        ...
        methods: {
            ...
            async update_patient_height(){
                await axios.put(`/api/v1/patient_system/patient/patient/${this.formData.patient.id}`,this.formData.patient).then(response=>{
                    if(response.data.success){
                        this.accessory.height_modal=false
                        this.$toast.open({message:'the height of the patient is updated',position:'top-right',type:'success'})
                    }
                })
            },
            resetForm() {
