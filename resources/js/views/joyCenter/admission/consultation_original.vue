                        ...
                        <v-card class="rounded-xl p-2">
                            ...
                            <div class="form-row">
                                <div class="col-sm-3 form-group ">
                                    ...
                                    <span v-if="accessories.noPatientFound" class="text-white bg-danger">No patient found</span>
                                    <input type="text"
                                           class="form-control form-control-sm"
                                           @change="changePat"
                                           v-model="formData.patient.id"
                                           :class="{'border border-danger':accessories.noPatientFound}"
                                    />
    ...
    export default {
        ...
        methods:{
          ...
          async init(){
              ...
              axios.get("/api/fokontany").then(response=> response.data.forEach(fkt=>this.accessories.fokontany.push(fkt.name.toLowerCase())))
          },
            async changePat(){
                ...
                .then(response=>{
                    ...
                    if(response.data.success){
                        ...
                        let check=false
                        adress.forEach(ad=>{
                            if(this.accessories.fokontany.indexOf(ad) !== -1){
                                check=true
                            }
                        })
                        ...
                        this.accessories.noPatientFound=true
                    }
                })
