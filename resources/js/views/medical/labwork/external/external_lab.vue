<template>
    <div class="container-fluid">
        <h6 class="text-center mt-2 form-title" v-if="accessory.form_type==='result'">External lab-work</h6>
        <h6 class="text-center mt-2 title" v-if="accessory.form_type !=='result'">C.2 External lab-work</h6>
