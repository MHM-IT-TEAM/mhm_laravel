...
<!--                        </tr>-->
                        <tr>
                            ...
                            <td :class="{'d-none':!formData.anesthesia_required}" colspan="4">
                                ...
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="anesthesia_type3" name="anesthesia_type" value="IVS" v-model="formData.anesthesia_type" class="custom-control-input">
                                    <label class="custom-control-label" for="anesthesia_type3">IVS</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="anesthesia_type4" name="anesthesia_type" value="epidural" v-model="formData.anesthesia_type" class="custom-control-input">
