<template>
    <div class="container-fluid w-75">
        <v-app hide-details>
            ...
            <div class="table-responsive mt-2 p-4 border shadow">
                    ...
                    <tr>
                        <td style="width:10%">
                            <div class="form-group">
                                ...
                                <input v-model="formData.patient_id" type="number"
                                       class="form-control form-control-sm"
                                       @change="change_patient" :class="{'error':$v.formData.patient_id.$error}"
                                />
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
                                ...
                                <input v-model="formData.firstName" type="text"  class="form-control form-control-sm "disabled/>
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
                                <label>Lastname</label>
                                <input v-model="formData.lastName" type="text" class="form-control form-control-sm" disabled/>
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
                                <label>Birthdate</label>
                                <input v-model="formData.birthDate" type="text"style="width:125px" class="form-control form-control-sm " disabled/>
                            </div>
                        </td>
                    </tr>
                    <tr >
                        <td>
                            <div class="form-group">
                                <label> Address:</label>
                                <input v-model="formData.address" type="text" class="form-control form-control-sm " disabled/>
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
                                <label>Tel:</label>
                                <input v-model="formData.tel" type="text" class="form-control form-control-sm " disabled/>
                            </div>
                        </td>
                        <td colspan="2">
                            <div class="form-group">
                                <label>Mail:</label>
                                <input v-model="formData.mail" type="text" class="form-control form-control-sm " disabled/>
                            </div>
                        </td>
                    </tr>
                </table>
                <table  class="table table-sm  mt-2">
                    ...
                    <tr class="border-none">
                        ...
                        <td>
                            <span>Bed:</span><span class="text-danger">*</span> <select :class="{'error':$v.formData.bed_id.$error}"  v-model="formData.bed_id"><option v-for="item in accessory.beds" :value="item.id" >{{item.description}}</option></select>
                    ...
                    <tr>
                        <td>
                            ...
                            <select v-model="formData.referred_patient" class="border">
                                <option v-for="v in accessory.yes_no" :value="v.value">{{v.name}}</option>
                            </select>
                        </td>
                        <td>
                           <div v-if="formData.referred_patient">
                                <span class="font-weight-bold mr-2">
                                From which hospital?
                            </span>
                               <select v-model="formData.src_hospital" class="border">
                                   <option v-for="v in accessory.hospitals" >{{v}}</option>
                               </select>
                           </div>
                        </td>
                    </tr>
    ...
    export default {
        ...
        data(){
            return{
                ...
                accessory:{
                    in_patient_service:'',
                    yes_no:[{name:'Yes',value:1},{name:'No',value:0}],
                    beds:'',
                    file:null,
                    last_code:'',
