<template>
    <div class="mt-2">
        <p class="table-title pl-6">D.1. Additional consultation</p>
        <div class="card">
            <div class="card-body" v-if="!accessory.data_submitted">
                <table class="table table-sm">
                    ...
                    <tr>
                        <td colspan="3">
                            <textarea class="form-control" v-model="formData.reason_for_consultation" placeholder="reason for the referral"></textarea>
                            <span v-if="$v.formData.reason_for_consultation.$error" class="text-white bg-danger">you have to explain why you refer the patient</span>
                        </td>
                    </tr>
                </table>
...
export default {
    ...
    methods:{
        ...
        submit(){
            ...
            this.formData.admission=this.admission
            axios.post('/api/v1/patient_system/additional_consultation',this.formData).then(response=>{
