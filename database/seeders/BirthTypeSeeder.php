...
class BirthTypeSeeder extends Seeder
{
    ...
    public function run()
    {
        BirthType::insert([
            ...
            ['name'=>'Re-re-C-section-secondary-primary'],
            ['name'=>'Re-re-C-section-secondary-normal'],
            ['name'=>'Re-re-C-section-secondary-urgent'],
            ['name'=>'Re-re-C-section-secondary-emergency'],
