...
class CreateCpnFollowupsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('cpn_followups', function (Blueprint $table) {
            $table->id();
            $table->timestamps();
            ...
            $table->string('cervix_consistency',50)->nullable();
            ...
            $table->string('appointment',50)->nullable();
            $table->string('senior_informed',100)->nullable();
            $table->string('responsible',50)->nullable();
            $table->text('remark')->nullable();
            $table->string('ctg_reason', 15)->nullable();
            $table->string('us_reason', 15)->nullable();
