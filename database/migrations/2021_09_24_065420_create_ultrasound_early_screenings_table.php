...
class CreateUltrasoundEarlyScreeningsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ultrasound_early_screenings', function (Blueprint $table) {
            $table->id();
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('ultrasound_early_screenings');
    }
}
