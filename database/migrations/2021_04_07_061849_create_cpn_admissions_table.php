...
class CreateCpnAdmissionsTable extends Migration
{
    ...
    public function up()
    {
        Schema::connection('patSyst')->create('cpn_admissions', function (Blueprint $table) {
            ...
            $table->String('dpa_calc',10)->nullable();
            ...
            $table->string('close_family_twins',50)->nullable();
            $table->string('close_family_disease',50)->nullable();
            $table->string('close_family_malformation',50)->nullable();
            $table->string('close_family_prob_in_preg',50)->nullable();
            $table->boolean('close_family_dead_baby')->nullable();
            $table->boolean('close_family_miscarriage')->nullable();
            $table->string('close_family_oc',50)->nullable();
            $table->string('preg_wom_disability',50)->nullable();
            $table->boolean('preg_wom_bleeding')->nullable();
            $table->boolean('preg_wom_haematoma')->nullable();
            $table->string('preg_wom_medication',50)->nullable();
